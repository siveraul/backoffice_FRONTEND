...
export default function Header() {
  ...
  const userNome = localStorage.getItem("NomeUser");
          ...
          <div className="main-header-left ">
            ...
            <div className="main-header-center ms-4 d-sm-none d-md-none d-lg-block form-group">
              <Form.Control defaultValue={InputValue}
                ...
                placeholder="Pesquisar numa pagina..."
                type="search"
              />
              ...
              {show1 ?
                <div className="card search-result position-absolute z-index-9 search-fix  border mt-1 w-100">
                  <div className="card-header pb-0">
                    <h4 className="card-title mb-0 me-2 text-break">Resultados da Pesquisa de {InputValue}</h4>
                  </div>
                  <ListGroup>
                    {show2 ?
                      NavData.map((e) =>
