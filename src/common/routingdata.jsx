...
//regioes
import Zonalist from '../components/advancedui/regioes/zonalist';
import Provincialist from '../components/advancedui/regioes/provincialist';
import Distritolist from '../components/advancedui/regioes/distritolist';

//aeroportos
import Aeroportolist from '../components/advancedui/aeroportos/aeroportolist';

//terminais
import Terminaislist from '../components/advancedui/terminais/terminaislist';
import SessaoTerminaislist from '../components/advancedui/terminais/sessaoterminaislist';

//tipocarga
import TipoCargalist from '../components/advancedui/tipocarga/tipocargalist';

//Entidade
import Entidadelist from '../components/advancedui/entidades/entidadelist';
import Taxalist from '../components/advancedui/entidades/taxalist';

//utilizadores
import Utilizadoreslist from '../components/advancedui/utilizadores/utilizadoreslist';

//perfis
import Perfislist from '../components/advancedui/perfis/perfislist';

//aprovacoes
import Aprovacoes from '../components/advancedui/aprovacoes/aprovacoes';

//aprovacoes Autoridade de Carga
import AprovacoesAutoridadeCarga from '../components/advancedui/aprovacoes/aprovacoesautoridade';

//aprovacoes Agente de Terminal
import AprovacoesAgenteDeTerminal from '../components/advancedui/aprovacoes/aprovacoesagentedeterminal';
...
//Dashboard
  ...
  //regioes
  { path:`${import.meta.env.BASE_URL}advancedui/zonalist`, element: <Zonalist /> },
  { path:`${import.meta.env.BASE_URL}advancedui/provincialist`, element: <Provincialist /> },
  { path:`${import.meta.env.BASE_URL}advancedui/distritolist`, element: <Distritolist /> },

  //aeroportos
  { path:`${import.meta.env.BASE_URL}advancedui/aeroportolist`, element: <Aeroportolist /> },

  //terminais
  { path:`${import.meta.env.BASE_URL}advancedui/terminaislist`, element: <Terminaislist /> },
  { path:`${import.meta.env.BASE_URL}advancedui/sessaoterminaislist`, element: <SessaoTerminaislist /> },

  //cargas
  { path:`${import.meta.env.BASE_URL}advancedui/tipocargalist`, element: <TipoCargalist /> },

  //entidade
  { path:`${import.meta.env.BASE_URL}advancedui/entidadelist`, element: <Entidadelist /> },
  { path:`${import.meta.env.BASE_URL}advancedui/taxalist`, element: <Taxalist /> },

  //utilizadores
  { path:`${import.meta.env.BASE_URL}advancedui/utilizadoreslist`, element: <Utilizadoreslist /> },

  //perfis
  { path:`${import.meta.env.BASE_URL}advancedui/perfislist`, element: <Perfislist /> },

   //aprovacoes
   { path:`${import.meta.env.BASE_URL}advancedui/aprovacoes`, element: <Aprovacoes /> },

   //aprovacoes
   { path:`${import.meta.env.BASE_URL}advancedui/aprovacoesautoridadecarga`, element: <AprovacoesAutoridadeCarga /> },

   //aprovacoes Agente Terminal
   { path:`${import.meta.env.BASE_URL}advancedui/aprovacoesagenteterminal`, element: <AprovacoesAgenteDeTerminal /> },
];
...
//regioes
{ path:`${import.meta.env.BASE_URL}advancedui/zonalist`, title: "Zonalist" },
{ path:`${import.meta.env.BASE_URL}advancedui/distritolist`, title: "Distritolist" },
{ path:`${import.meta.env.BASE_URL}advancedui/provincialist`, title: "Provincialist" },

//aeroportos
{ path:`${import.meta.env.BASE_URL}advancedui/aeroportolist`, title: "Aeroportolist" },

//terminais
{ path:`${import.meta.env.BASE_URL}advancedui/terminaislist`, title: "Terminaislist" },
{ path:`${import.meta.env.BASE_URL}advancedui/sessaoterminaislist`, title: "SessaoTerminaislist" },

//tipo_carga
{ path:`${import.meta.env.BASE_URL}advancedui/tipocargalist`, title: "TipoCargalist" },

//entidade
{ path:`${import.meta.env.BASE_URL}advancedui/entidadelist`, title: "Entidadelist" },
{ path:`${import.meta.env.BASE_URL}advancedui/taxalist`, title: "Taxalist" },

//utilizadores
{ path:`${import.meta.env.BASE_URL}advancedui/utilizadoreslist`, title: "utilizadoreslist" },

//perfis
{ path:`${import.meta.env.BASE_URL}advancedui/perfislist`, title: "perfislist" },

//aprovacoes
{ path:`${import.meta.env.BASE_URL}advancedui/aprovacoes`, title: "aprovacoes" },

//aprovacoes Autoridade Carga
{ path:`${import.meta.env.BASE_URL}advancedui/aprovacoesautoridadecarga`, title: "aprovacoesautoridadecarga" },

//aprovacoes Agente Terminal
{ path:`${import.meta.env.BASE_URL}advancedui/aprovacoesagenteterminal`, title: "aprovacoesagenteterminal" },
